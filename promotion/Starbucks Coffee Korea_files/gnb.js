...
'								<li><a href="/menu/drink_list.do?CATE_CD=product_blended">블렌디드 음료</a></li>' +
'								<li><a href="/menu/drink_list.do?CATE_CD=product_fizzo">스타벅스 피지오</a></li>' +
'								<li><a href="/menu/drink_list.do?CATE_CD=product_tea">티</a></li>' +
...
'								<li><a href="/menu/food_list.do?CATE_CD=product_cake">케익</a></li>' +
...
'								<li><a href="/menu/product_list.do?CATE_CD=product_teaPackage">패키지 티</a></li>' +
//'								<li><a href="/menu/product_list.do?CATE_CD=product_planner">2016 스타벅스 플레너</a></li>' +
'							</ul>' +
'							<ul>' +
...
'						<div class="gnb_sub_tx_inner">' +
'							<div class="gnb_sub_tx_left">' +
'								<h3><a href="/menuStory/teavana.do">스타벅스 티바나 <img alt="" src="//image.istarbucks.co.kr/common/img/common/icon_gnb_new.png"></a></h3>' +
'								<p class="gnb_sub_ex_txt">다양한 찻잎과 향신료 등 개성있는 재료로 새로운 맛과 향의 티를 선보입니다. </p>' + 
...
'							</ul>' +
'							<ul>' +
'								<li class="gnb_sub_ttl"><a href="/store/store_food.do">프리미어 푸드 매장</a></li>' +
'							</ul>' +
'							<ul>' +
'								<li class="gnb_sub_ttl"><a>매장 이야기</a></li>' +
'								<li><a href="/store/store_star_field.do">스타필드하남1F(티바나)</a></li>' +
...
'								<h3><a href="/store/store_star_field.do">스타필드하남1F(티바나) <img alt="" src="//image.istarbucks.co.kr/common/img/common/icon_gnb_new.png"></a></h3>' +
'								<p class="gnb_sub_ex_txt">스타필드하남1F(티바나)점에서 스타벅스 티바나만이 차별화된 경험을 만나보세요.</p>' +
'							</div>' +
'							<div class="gnb_sub_tx_right">' +
'							</div>' +
'						</div>' +
...
'							</ul>' +
'							<ul>' +
'								<li class="gnb_sub_ttl"><a href="/msr/sceGift/egift_information.do">스타벅스 카드 e-Gift</a></li>' +
'								<li><a href="/msr/sceGift/egift_information.do">스타벅스 카드 e-Gift 소개</a></li>' +
...
'								<li><a href="/whats_new/2016planner.do">2016 스타벅스 플래너</a></li>' +
'							</ul>' +
'							<ul>' +
...
'								<li><a href="/whats_new/store_event_list.do">신규 매장</a></li>' +
'							</ul>' +
/*'							<ul>' +
'								<li class="gnb_sub_ttl"><a href="/eFreq/guide.do">e-프리퀀시</a></li>' +
'								<li><a href="/eFreq/guide.do">이용안내</a></li>' +
'								<li><a href="/eFreq/index.do" required="login">이용현황</a></li>' +
'							</ul>' +*/
'							<ul>' +
'								<li class="gnb_sub_ttl"><a href="/whats_new/notice_list.do">공지사항</a></li>' +
'							</ul>' +
'							<ul>' +
'								<li class="gnb_sub_ttl"><a href="/whats_new/social_sbucks.do">소셜 스타벅스</a></li>' +
'							</ul>' +
'							<ul>' +
'								<li class="gnb_sub_ttl"><a href="/whats_new/wallpaper.do">월페이퍼/스크린세이버</a></li>' +
'							</ul>' +
'						</div>' +
'					</div>' +
'					<!-- 텍스쳐 bg -->' +
...
'								<h3><a href="/whats_new/social_sbucks.do">소셜 스타벅스</a></h3>' +
'								<p class="gnb_sub_ex_txt">다양한 스타벅스 SNS 채널을 통해 스타벅스를 만나보세요!</p>' +
'							</div>' +
'							<div class="gnb_sub_tx_right">' +
'							</div>' +
'						</div>' +
...
'		</ul>';
		        ...
		        if(data.list.length > 0) {
		            ...
		            $.each( data.list, function(x, y) {
				        ...
				        if(y.links != "") {
				            ...
				            tmpStr += '<a href="'+y.links+'" '+tmpTarget+' '+tmpRequired+'>';
				        }
				        
						tmpStr += '		<div class="gnb_sub_right_bnr_img"><img alt="" src="'+y.img_UPLOAD_PATH.replace("www", "image") +'/upload/banner/'+y.img_NM+'"></div>';
	...
	var btnSearch = '<input id="totalSearch" placeholder="통합검색" type="text">';
