var m_domain_ssl  = "https://" + location.hostname;
var m_domain_http = "http://" + location.hostname;
...
$.loginLib = {
	...
	/*
	,setCaptcha : function () {
		__ajaxCall(m_domain_ssl + "/interface/getLoginHistoryCnt.do", {}, true, "jsonp", "post"
			,function (_response) {
				if (_response.result_code == "SUCCESS") {
	...
	,getCookieSaveId : function (_fnSuccess) {
		__ajaxCall(m_domain_ssl + "/interface/getCookieSaveId.do", {}, true, "jsonp", "post"
			,function (_response) {
				if (_response.result_code == "SUCCESS") {
	...
	*/
	...
	,logout : function () {
		__ajaxCall(m_domain_ssl + "/interface/logoutMember.do", {}, true, "jsonp", "post"
			,function (_response) {
	...
	,getMsrRewardSummary : function () {
		//if (m_jsonRewardSummary == null) {
			__ajaxCall(m_domain_ssl + "/interface/getMsrRewardSummary.do", {}, true, "jsonp", "post"
				,function (_response) {
					if (_response.result_code == "SUCCESS") {
						...
						// 사진
						if (m_jsonRewardSummary.profileImgUrl != "") {
							$(".user_pic_area img").attr("src", m_jsonRewardSummary.profileImgUrl);
						}
						...
						if (m_jsonRewardSummary.msrMemberYn == "N"
							...
							$(".user_level").hide();
							$(".msr_lead").show();
							$(".msr_card_info , .msr_card_zone , .mycard_money_result").hide();
							$(".sb_card_regi").show();
						} else {
							$(".user_level").show();
							$(".msr_lead").hide();
							...
							switch(m_jsonRewardSummary.userGrade) {
								case "00":
									...
									strStatNotice_center = '<strong class="t_fff en">Welcome Level</strong><br><span class="green">Green Level</span>이 되기까지<br>' + nNextGradeStar + '개의 별이 필요합니다.';
									break;
								...
								case "11":
									...
									strStatNotice_center = '<strong class="t_03934b en">Green Level</strong><br><span class="t_ac8432">Gold Level</span>이 되기까지<br>' + nNextGradeStar + '개의 별이 필요합니다.';
									break;
								...
								case "21":
									...
									strStatNotice_top = '<strong class="t_ac8432 en">Gold Level</strong><br>' + nNextGradeStar + '개의 별★이 더 모이면<br><span class="t_ac8432">Gold Level</span>을<br>1년 더 유지할 수 있습니다!';
									if (nNextGradeStar < 0) {
										var nRemainStar = 12 - nTotalStar;
										if (nRemainStar < 0) {
											nRemainStar = 0;
										}
										strStatNotice_top = '<strong class="t_ac8432 en">Gold Level</strong><br />무료음료 쿠폰 발행까지<br />' + nRemainStar + '개의 별이 남았습니다.';
									}
	...
	,showInboxNoCnt : function () {
		__ajaxCall(m_domain_ssl + "/interface/getInboxNoCnt.do", {}, true, "jsonp", "post"
			,function(_response) {
				if (_response.result_code == "SUCCESS") {
