$(document).ready(function(){
	...
	$.menuProduct = {
			tmplete1 : function(){
				...
				tmplete = tmplete + '<li>';
				tmplete = tmplete + 		'<dl>';
				tmplete = tmplete + 			'<dt><a href="javascript:void(0);" class="jy_listAttr" tmpAttr="${$item.product_CD()}" tmpCate="${$item.f_CATE_CD()}"><img alt="" src="${$item.file_PATH().replace("www", "image")}"></a></dt>';
